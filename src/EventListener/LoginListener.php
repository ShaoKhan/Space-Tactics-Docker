...
class LoginListener implements AuthenticationSuccessHandlerInterface
{
    ...
    ): ?Response
    {
        ...
        // Sicherheitscheck für Planeten
        if (empty($planets)) {
            // Keine Planeten gefunden - hier könnten Sie einen Standardplaneten erstellen
            return null;
        }
        
        // Nehmen Sie den ersten verfügbaren Planeten
        $actualPlanetId = $planets[0]->getId();
        $now            = new DateTime();
