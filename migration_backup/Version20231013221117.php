 ...
 */
final class Version20231013221117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE building_dependencies (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, required_building_id INT DEFAULT NULL, required_science_id INT DEFAULT NULL, required_building_level INT DEFAULT NULL, required_science_level INT DEFAULT NULL, INDEX IDX_71F64E02D691282 (required_building_id), INDEX IDX_71F64E0268C3BD10 (required_science_id), INDEX IDX_71F64E024D2A7E12 (building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1043Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1043Platform'."
        );
        ...
        $this->addSql('CREATE TABLE planet_building (id INT AUTO_INCREMENT NOT NULL, planet_id INT NOT NULL, building_id INT NOT NULL, building_level INT NOT NULL, INDEX IDX_922654004D2A7E12 (building_id), INDEX IDX_92265400A25E9820 (planet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1043Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1043Platform'."
        );
