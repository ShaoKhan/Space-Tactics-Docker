 ...
 */
final class Version20231013220452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE building_dependencies (id INT AUTO_INCREMENT NOT NULL, building_id INT NOT NULL, required_building_id INT DEFAULT NULL, required_science_id INT DEFAULT NULL, required_building_level INT DEFAULT NULL, required_science_level INT DEFAULT NULL, INDEX IDX_71F64E0268C3BD10 (required_science_id), INDEX IDX_71F64E024D2A7E12 (building_id), INDEX IDX_71F64E02D691282 (required_building_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1043Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1043Platform'."
        );
        ...
        $this->addSql('CREATE TABLE sciences (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, science_class INT NOT NULL, one_per_planet INT NOT NULL, factor INT NOT NULL, level_max INT NOT NULL, cost_metal INT NOT NULL, cost_crystal INT NOT NULL, cost_deuterium INT NOT NULL, cost_dark_matter INT NOT NULL, image VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1043Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1043Platform'."
        );
        ...
        $this->addSql('CREATE TABLE ships (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, class INT NOT NULL, one_per_planet INT NOT NULL, level_max INT NOT NULL, cost_metal INT NOT NULL, cost_crystal INT NOT NULL, cost_deuterium INT NOT NULL, cost_dark_matter INT NOT NULL, consumption_deuterium INT NOT NULL, capacity INT NOT NULL, attack INT NOT NULL, defense INT NOT NULL, drive_science INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\MariaDb1043Platform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MariaDb1043Platform'."
        );
